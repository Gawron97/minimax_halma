...
class Game:
    ...
    def play_game(self, starting_player: Player, enemy: Player, depth):
        ...
        while(not self.board.is_no_more_possible_moves()):
            ...
            move = self.find_best_move_for_player(current_player1, current_player2, depth)
            if(move):
    ...
    def find_best_move_for_player(self, current_player: Player, enemy: Player, depth):
